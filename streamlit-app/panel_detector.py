...
if uploaded_image is not None:
    ...
    if st.button("Generate results"):
        ...
        st.image(inverted_mask, caption="ask (Black and White with Blue in Bright)", use_column_width=True)
        st.image(result_image, caption="Result (White for Blue, Grayscale for Others)", use_column_width=True)
